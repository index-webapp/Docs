...
description: "Configure SURCHI webhooks to receive real-time HTTP POST notifications for price alerts, large wallet movements, new token listings, and contract risk changes."
---
