---
title: "SURCHI API Error Codes, Status Codes, and Debugging"
sidebarTitle: "Errors"
description: "Complete reference of SURCHI API error codes, HTTP status codes, rate limit handling, and troubleshooting steps for common API integration issues."
---
