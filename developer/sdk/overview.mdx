...
description: "The SURCHI SDK provides type-safe clients for JavaScript, TypeScript, and Python to query tokens, wallets, contracts, and liquidity routing from your application."
---
